...
from produtos.views import CategoriaCreateView, CategoriaDeleteView, CategoriaListView, CategoriaUpdateView, ProdutoListView, ProdutoUpdateView, ProdutoCreateView, ProdutoDeleteView
